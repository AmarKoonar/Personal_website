...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center relative px-4 md:px-10 pt-8 pb-6"
      ref={containerRef}
    >
      <div
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl mx-auto w-full border-4 border-[#6C6C6C] p-4 bg-[#222222] rounded-[30px] shadow-2xl"
    >
